            ...
            <div class="col-md-12 col-xl-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form action="{{route('admins.sanpham.update',$listDanhMuc->id)}}" method="post"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="example-select" name="trang_thai">
                                            ...
                                            <option value="0" {{$listSanPham->is_type ==true ?  'checked' : ' '}} >

                                                Ẩn
                                            </option>
                                            <option value="1" {{$listSanPham->is_type ==false ?  'checked' : ' '}} >
                                                Hiển Thị
                                            </option>
                                        </select>
